...
| **R16** | **macOS-CI-Minuten** sind der einzige Posten, der das 0-€-Ziel kippen kann: macOS-Runner kosten 0,062 $/min gegen 0,006 $/min Linux (Faktor ~10) ⇒ nur ~200 macOS-Minuten im Freikontingent eines privaten Repos. Wenige Xcode-Builds pro Tag reißen das. | 🟠 | **Keine macOS-CI in P0.** Auf GitHub laufen ausschließlich Linux-Jobs (SQL-Tests, Keep-alive). Der Xcode-Build läuft lokal. Spätere Alternative: Repo öffentlich stellen, dann sind auch macOS-Runner kostenlos. | P0.1 ✅ |
